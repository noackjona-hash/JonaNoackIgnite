...
class NavigationRail(ctk.CTkFrame):
    ...
    NAV_ITEMS = [
        ...
        ("single",    "🔍", "Inspektion", "Einzelbild & ROI-Messung"),
        ("analytics", "📈", "Statistik", "Temperatur-Histogramm"),
        ("podology",  "🦶", "Podologie", "3-Zonen & Symmetrie"),
        ("batch",     "📁", "Stapelanalyse", "Serienuntersuchung"),
        ("settings",  "⚙️", "Einstellungen", "Parameter & Kalibrierung"),
    ]
    ...
    def _build_ui(self) -> None:
        ...
        ctk.CTkLabel(
            ...
            anchor="w"
        ).pack(fill=ctk.X, padx=12, pady=(4, 8))
        ...
        for key, icon, title, subtitle in self.NAV_ITEMS:
            ...
            content_box.pack(fill=ctk.BOTH, expand=True, padx=10, pady=4)
            ...
            # Klick-Handler auf alle Widgets
            _k = key
        ...
        # Unten: Schnell-Aktionen (Bericht-Export)
    ...
    def select_tab(self, key: str, notify: bool = True) -> None:
        """Aktiviert einen Tab mit Google Material 3 Hervorhebung."""
    ...
    def update_loaded_file(self, filename: str | None) -> None:
        """Aktualisiert die Dateistatus-Anzeige in der Navigation."""
        if filename:
