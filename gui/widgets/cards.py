...
class AnalysisModeCard(ctk.CTkFrame):
    ...
    def __init__(self, master, on_change_callback, **kwargs):
        ...
        hdr_frame.pack(fill=ctk.X, padx=14, pady=(10, 4))
        ...
        self.option_menu.pack(fill=ctk.X, padx=14, pady=(4, 12))
...
class RoiCard(ctk.CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        roi_title.pack(padx=14, pady=(10, 4), anchor="w")

        self.info_lbl = ctk.CTkLabel(
            self,
            text="Ziehe mit der Maus auf einem Bild ein Rechteck auf, um eine Region of Interest (ROI) live auszuwerten.",
        ...
        self.info_lbl.pack(fill=ctk.X, padx=14, pady=(4, 12))
...
class SystemSettingsCard(ctk.CTkFrame):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.toggle_btn.pack(fill=ctk.X, padx=6, pady=6)
        ...
        ctk.CTkLabel(calib_row, text="T-Min (°C)", font=ctk.CTkFont(size=10), text_color=COLOR_TEXT_SECONDARY).grid(row=0, column=0, sticky="w")
        ctk.CTkLabel(calib_row, text="T-Max (°C)", font=ctk.CTkFont(size=10), text_color=COLOR_TEXT_SECONDARY).grid(row=0, column=1, sticky="w", padx=(8, 0))

        self.t_min_entry = ctk.CTkEntry(
            calib_row,
            placeholder_text=str(config.DEFAULT_TEMP_MIN),
        ...
        self.t_max_entry = ctk.CTkEntry(
            calib_row,
            placeholder_text=str(config.DEFAULT_TEMP_MAX),
            font=ctk.CTkFont(family=FONT_FAMILY, size=12),
            fg_color=COLOR_BG_INPUT,
            border_color=COLOR_BORDER_INPUT,
            text_color=COLOR_TEXT_PRIMARY,
        ...
        self.export_browse_btn.pack(side=ctk.RIGHT, padx=(6, 0))
...
class PipelineParametersCard(ctk.CTkFrame):
    ...
    def __init__(self, master, toggle_callback, update_params_callback, **kwargs):
        ...
        self.sigma_k_slider, self.sigma_k_val = make_slider(self.sliders_frame, "Threshold-Faktor (k)", 1.0, 5.0, config.DEFAULT_SIGMA_K, 0.1)
        ...
        self.mad_switch.pack(fill=ctk.X, padx=10, pady=(6, 6))
        ...
        self.asymmetry_switch.pack(fill=ctk.X, padx=10, pady=(0, 12))
...
class AnalysisInfoCard(ctk.CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.filename_label.pack(fill=ctk.X, padx=16, pady=(12, 4))
        ...
        self.backend_label.pack(fill=ctk.X, padx=16, pady=2)
        ...
        self.status_label.pack(fill=ctk.X, padx=16, pady=2)
        ...
        self.hotspot_label.pack(fill=ctk.X, padx=16, pady=4)
        ...
        self.pixel_info_label.pack(fill=ctk.X, padx=16, pady=(2, 12))
