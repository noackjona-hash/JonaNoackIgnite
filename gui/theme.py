...
# Base app background
COLOR_BG_APP            = ("#F8F9FA", "#1A1A1C")

# Navigation sidebar / rail
COLOR_BG_NAV            = ("#FFFFFF", "#202124")

# Cards & elevated containers
COLOR_BG_CARD           = ("#FFFFFF", "#292A2D")
COLOR_BG_CARD_VARIANT   = ("#F1F3F4", "#303134")
COLOR_BG_CARD_HOVER     = ("#F8F9FA", "#35363A")

# Input fields, chips, text entries
COLOR_BG_INPUT          = ("#F1F3F4", "#303134")
COLOR_BG_INPUT_HOVER    = ("#E8EAED", "#3C4043")

# Primary tonal containers (Google Blue tinted)
