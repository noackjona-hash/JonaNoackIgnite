...
def make_status_chip(
    ...
    **kwargs
    ...
    dot.pack(side=ctk.LEFT, padx=(8, 4), pady=4)
...
def make_slider_setting(
    ...
    row_frame.pack(fill=ctk.X, pady=6)
    ...
    if description:
        ...
        lbl_desc.pack(fill=ctk.X, pady=(0, 4))

    # Callback wrapper, der das Badge live aktualisiert
